...
The following script installs a JetBrains IDE on any [Debian based Linux distro](https://en.wikipedia.org/wiki/List_of_Linux_distributions#Debian-based). To use it, paste `wget z.ndan.co/jetbrains-install.sh` into a terminal to fetch the script below:

...
The folks training these models are college dropouts and software developers, not geniuses. If we're lucky, maybe they took an online course in machine learning. There should be some kind of independent evaluation system put into place, to verify big models are free from bias. Knowing developers, ifwe create a monster, it will most likely be out of [stupidity than malice](https://en.wikipedia.org/wiki/Hanlon's_razor).
